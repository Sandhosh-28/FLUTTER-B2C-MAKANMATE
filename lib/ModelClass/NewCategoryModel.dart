import 'CategoriesByLocation.dart';
...
class NewCategoryModel {
  ...
  NewCategoryModel.fromJson(dynamic json) {
    ...
    if (json['CategoriesByLocation'] != null) {
      categoriesByLocation = [];
      json['CategoriesByLocation'].forEach((v) {
        categoriesByLocation?.add(CategoriesByLocation.fromJson(v));
      });
    }
  }
  int? orgId;
  ...
  List<CategoriesByLocation>? categoriesByLocation;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (categoriesByLocation != null) {
      map['CategoriesByLocation'] = categoriesByLocation?.map((v) => v.toJson()).toList();
    }
    return map;
  }
